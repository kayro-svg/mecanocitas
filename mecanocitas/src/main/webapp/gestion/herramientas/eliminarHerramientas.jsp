...
String id_herramienta = request.getParameter("id_herramienta");
    ...
    String sqlHerramienta = " DELETE FROM herramienta WHERE id_herramienta= '" + id_herramienta + "'";
...
<div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
  ...
  <div>
    ...
    out.println("setTimeout(function() { window.location.href = 'herramientas.jsp'; }, 1000);");
    out.println("</script>");
%>
