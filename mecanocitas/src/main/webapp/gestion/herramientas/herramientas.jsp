...
<%@page import="java.sql.Connection"%>
	...
	String id_herramienta = ""; //declaracion de la variable 'descripcion' de tipo string 
	id_herramienta = (request.getParameter("id_herramienta") != null) ? request.getParameter("id_herramienta") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "
...
<title>MecanoCitas - Herramientas</title>
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<img alt="" src="../../public/tools2@2x.png"
					...
					<a class="nuevo-boton" href="formCrearHerramienta.jsp"> NUEVA
						HERRAMIENTA<img class="icon" src="../../public/plus@2x.png"
...
<td>
    <a href="editarherramienta.jsp?id_herramienta=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
    </a>
</td>

				<td><a href="eliminarHerramientas.jsp?id_herramienta=<%=rs.getString(1)%>"> <img class="link-icon"
