...
<%
    ...
    String queryInsertVehiculo = "INSERT INTO vehiculo (matricula, serieVin, marca, modelo, color, año) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    stmtInsertVehiculo.setString(6, año);
    ...
    <div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
      ...
      <div>
       ...
       out.println("</script>");
        ...
        out.println("Ocurrió un fallo en la inserción del Vehiculo con matricula: " + matricula);
    }
