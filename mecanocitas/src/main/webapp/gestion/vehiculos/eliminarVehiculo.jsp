...
try {
    ...
    String sqlIdCliente = "SELECT id_cliente FROM clientevehiculo WHERE id_vehiculo = '" + id_vehiculo + "'";
    ...
    if (rs.next()) {
        ...
        String sqlVehiculoCliente = "DELETE FROM clientevehiculo WHERE id_vehiculo = '" + id_vehiculo + "' and id_cliente = '" + id_cliente + "'";
        st.executeUpdate(sqlVehiculoCliente);
    }
 %>
...
<div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
  ...
  <div>
    ...
    out.println("setTimeout(function() { window.location.href = 'vehiculos.jsp'; }, 1000);");
    out.println("</script>");
} catch (Exception e) {
