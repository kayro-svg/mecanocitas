...
<%@page import="java.sql.Connection"%>
	...
	String id_telefono = ""; //declaracion de la variable 'descripcion' de tipo string 
...
String query = "SELECT v.id_vehiculo, c.nombre, c.apellido, c.cedula, v.matricula, v.serieVin, v.marca, v.modelo, v.color, v.año " +
	    "FROM Vehiculo v " +
...
<title>MecanoCitas - Vehículos</title>
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior" >
					...
					<img alt="" src="../../public/car1@2x.png"
						style="width: 50px; height: 50px; margin: 0;" />
					<h1>VEHÍCULOS</h1>
					</div>
					
					<div>
						<form class="barra-buscar" action="vehiculos.jsp" method="get">
...
<td>
    <a href="editarVehiculo.jsp?id_vehiculo=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
    </a>
</td>

				<td><a href="eliminarVehiculo.jsp?id_vehiculo=<%=rs.getString(1)%>"> <img class="link-icon"
