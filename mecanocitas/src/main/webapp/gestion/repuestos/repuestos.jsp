...
<%@page import="java.sql.Connection"%>
	...
	String id_repuesto = ""; //declaracion de la variable 'descripcion' de tipo string 
	id_repuesto = (request.getParameter("id_repuesto") != null) ? request.getParameter("id_repuesto") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<a class="nuevo-boton" href="formCrearRepuesto.jsp"> NUEVO
						REPUESTO<img class="icon" src="../../public/plus@2x.png"
...
<td>
    <a href="editarrepuesto.jsp?id_repuesto=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
    </a>
</td>

				<td><a href="eliminarRepuesto.jsp?id_repuesto=<%=rs.getString(1)%>"> <img class="link-icon"
