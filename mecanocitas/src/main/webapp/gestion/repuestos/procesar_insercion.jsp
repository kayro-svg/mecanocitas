...
<%
    ...
    String sql = "INSERT INTO repuesto (descripcion, valor, cantidad)";
    		sql = sql +" VALUES ('" + descripcion + "', '" + valor + "', '" + cantidad + "')";
  ...
  <div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
    ...
    <div>
      ¡Nuevo Repuesto Agregado correctamente!
    </div>
  </div>
  </div>
  	<%
    	    out.println("<script type=\"text/javascript\">");
    	    out.println("setTimeout(function() { window.location.href = 'repuestos.jsp?id_repuesto'; }, 1000);");
    	    out.println("</script>");
