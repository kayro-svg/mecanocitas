...
String id_repuesto = "";
id_repuesto = (request.getParameter("id_repuesto") != null) ? request.getParameter("id_repuesto") : "0"; // consulta en la URL es diferente de null
...
String query="select id_repuesto, descripcion, valor, cantidad"; 
query += " from repuesto where id_repuesto LIKE '%" + id_repuesto + "%'";
...
<title>MecanoCitas - Editar Repuesto</title>
...
<div class="titulo">
<h1 class="titulo-texto">NUEVO RESPUESTO</h1>
</div>
...
<div style="height: fit-content;">
 ...
 <label style="font-size: 18px;">Actualizar Repuesto</label>
  </div>
</div>
...
<input type="hidden" name="id_repuesto" value="<%=rs.getString(1)%>">
    ...
    <div class="form_texto">
    <input class="form-crear-input" type="text" name="valor" placeholder="000.00" value="<%=rs.getString(3)%>"  required>
    <label>Valor</label>
    </div>
    
    <div class="form_texto" >
    <input class="form-crear-input" type="number" name="cantidad" value="<%=rs.getString(4)%>" required>
...
<div class="cancel-save-boton-editar" style="margin-top: -75px;"> 
	<a href="repuestos.jsp" class="boton-cancelar" id="boton-login">
    CANCELAR
  </a>
