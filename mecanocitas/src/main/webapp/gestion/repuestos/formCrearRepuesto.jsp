...
<title>MecanoCitas - Nuevo Repuesto</title>
...
<div style="height: fit-content;">
 ...
 <label style="font-size: 18px;">Ingresa un nuevo Repuesto</label>
  </div>
</div>
...
<form style="margin-top: -65px;" class="form-editar" action="procesar_insercion.jsp" method="post">
    ...
    <div class="form_texto" >
    <input class="form-crear-input" type="number" name="cantidad"  required>
