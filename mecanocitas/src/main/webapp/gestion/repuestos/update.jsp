...
String sql = "update repuesto set descripcion='" + descripcion + "', valor='" + valor + "', cantidad='"
		+ cantidad + "' where id_repuesto='" + id_repuesto + "'";
...
<%
    ...
    out.println("setTimeout(function(){ window.location.href='repuestos.jsp'; }, 1000);");
    out.println("</script>");
}
