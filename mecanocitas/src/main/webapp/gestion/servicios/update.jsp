...
String sql = "update servicio set descripcion='" + descripcion + "', observacion='" + observacion + "', tiempo='"
		+ tiempo + "',valor='" + valor + "' where id_servicio='" + id_servicio + "'";
...
<%
    ...
    out.println("setTimeout(function(){ window.location.href='servicios.jsp'; }, 1000);");
    out.println("</script>");
}
