...
<%
    ...
    String sql = "INSERT INTO servicio (descripcion, observacion, tiempo, valor)";
    		sql = sql +" VALUES ('" + descripcion + "', '" + observacion + "', '" + tiempo + "', '" + valor + "')";
    ...
    <div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
      ...
      <div>
        ¡Nuevo Servicio Agregado correctamente!
      </div>
    </div>
    </div>
    	<%
    	    out.println("<script type=\"text/javascript\">");
    	    out.println("setTimeout(function() { window.location.href = 'servicios.jsp?id_servicio'; }, 1000);");
    	    out.println("</script>");
