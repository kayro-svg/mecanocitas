...
String id_servicio = "";
id_servicio = (request.getParameter("id_servicio") != null) ? request.getParameter("id_servicio") : "0"; // consulta en la URL es diferente de null
...
String query="select id_servicio, descripcion, observacion, tiempo, valor"; 
query += " from servicio where id_servicio LIKE '%" + id_servicio + "%'";
...
<title>MecanoCitas - Servicios</title>
...
<div class="titulo">
<h1 class="titulo-texto">EDITAR SERVICIO</h1>
</div>
...
<form style="margin-top: -40px;" class="form-editar" action="update.jsp" method="post">
    
     <input type="hidden" name="id_servicio" value="<%=id_servicio%>" required>
    ...
    <div class="form_texto" >
    <input class="form-crear-input" type="text" name="tiempo" placeholder="00:00:00" value="<%=rs.getString(4)%>" required>
    <label>Tiempo</label>
    </div>  
    <div class="form_texto">
    <input class="form-crear-input" type="text" name="valor" placeholder="000.00" value="<%=rs.getString(5)%>"  required>
    <label>Valor</label>
    </div>
</div>
...
<label style="	font-size: 14px;
 ...
 <div style="display: flex; margin: 0; align-items: center;
  justify-content: center;height: fit-content;">
     ...
     <textarea  style="margin-top: -120px;"  name="observacion" id="observacion" rows="2" cols="60"><%=rs.getString(3)%></textarea>
    </div>
