...
<%@page import="java.sql.Connection"%>
	...
	String id_servicio = ""; //declaracion de la variable 'descripcion' de tipo string 
	id_servicio = (request.getParameter("id_servicio") != null) ? request.getParameter("id_servicio") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<img alt="" src="../../public/service1@2x.png"
					...
					<a class="nuevo-boton" href="formCrearServicio.jsp"> NUEVO
						SERVICIO<img class="icon" src="../../public/plus@2x.png"
...
<td>
    <a href="editarservicio.jsp?id_servicio=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
    </a>
</td>

				<td><a href="eliminarServicio.jsp?id_servicio=<%=rs.getString(1)%>"> <img class="link-icon"
