...
String id_mecanico = "";
id_mecanico = (request.getParameter("id_mecanico") != null) ? request.getParameter("id_mecanico") : "0"; // consulta en la URL es diferente de null
...
<input type="hidden" name="id_mecanico" value="<%=rs.getString(1)%>" >
    ...
    <input class="form-crear-input" type="text" name="nombre" value="<%=rs.getString(2)%>" required>
    <label>Nombre</label>
    </div>
   
    <div class="form_texto">
    <input class="form-crear-input" type="text" name="apellido" value="<%=rs.getString(3)%>" required>
    <label>Apellido</label>
    </div>
    
    <div class="form_texto" >
    <input class="form-crear-input" type="text" name="cedula" value="<%=rs.getString(4)%>" required>
    <label>Cédula</label>
    </div> 
</div>
