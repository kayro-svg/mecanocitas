...
String query = "SELECT t.id_telefono, t.descripcion, c.cedula, c.nombre, c.apellido " +
	    "FROM Telefono t " +
	    "INNER JOIN telCliente tc ON t.id_telefono = tc.id_telefono " +
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<img alt="" src="../../public/phone1@2x.png"
						style="width: 50px; height: 50px; margin: 0;" />
					<h1>TELÉFONOS</h1>
					</div>
					
			<div>
						<form class="barra-buscar" action="telefonos.jsp" method="get">
...
<td>
    <a href="editartelefono.jsp?id_telefono=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
    </a>
</td>
					
				<td><a href="eliminarTelefono.jsp?id_telefono=<%=rs.getString(1)%>"> <img class="link-icon"
