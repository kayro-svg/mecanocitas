...
try {
    ...
    String sqlIdCliente = "SELECT id_cliente FROM clientedireccion WHERE id_direccion = '" + id_direccion + "'";
    ...
    if (rs.next()) {
        ...
        String sqlDirCliente = "DELETE FROM clientedireccion WHERE id_direccion = '" + id_direccion + "' and id_cliente = '" + id_cliente + "'";
        st.executeUpdate(sqlDirCliente);
    }

    
    String sqlDireccion = "DELETE FROM direccion WHERE id_direccion = '" + id_direccion + "'";
