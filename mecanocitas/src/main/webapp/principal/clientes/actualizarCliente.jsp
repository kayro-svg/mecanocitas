...
String email = request.getParameter("email"); 
    ...
    String updateQuery = "update cliente set cedula='" + cedula + "', nombre='" + nombre + "', apellido='"
    		+ apellido + "',email='" + email + "' where id_cliente='" + id_cliente + "'";

int flag = st.executeUpdate(updateQuery);
...
<%
    ...
    out.println("setTimeout(function(){ window.location.href='clientes.jsp'; }, 1000);");
    out.println("</script>");
}
