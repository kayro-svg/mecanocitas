...
String idcliente = ""; //declaracion de la variable 'descripcion' de tipo string 
idcliente = (request.getParameter("idcliente") != null) ? request.getParameter("idcliente") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "

String nombre = ""; //declaracion de la variable 'descripcion' de tipo string 
nombre = (request.getParameter("nombre") != null) ? request.getParameter("nombre") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "

String cedula = ""; //declaracion de la variable 'descripcion' de tipo string 
cedula = (request.getParameter("c.cedula") != null) ? request.getParameter("c.cedula") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "
...
query += "WHERE c.id_cliente LIKE '%" + idcliente + "%' and c.nombre LIKE '%" + nombre + "%' and  c.cedula LIKE '%" + cedula + "%' ";
...
<title>MecanoCitas - Clientes</title>
</head>
<body>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.min.js" integrity="sha384-cuYeSxntonz0PPNlHhBs68uyIAVpIIOZZ5JqeqvYYIcEL727kskC66kF92t6Xl2V" crossorigin="anonymous"></script>
	...
	<main class="contenedor">
		...
		if (moduloActivo == null) {
			moduloActivo = 1; // Valor predeterminado o lógica para manejar cuando no está definido
		}
		%>
		<!-- MENU LATERAL -->
		...
		<div>
			<div class="links">
				...
				<ul class="lista-horizontal-sup-izq">
					...
					<li>
						<div class="link">
							<img class="link-icon" alt=""
								...
								href="../../gestion/telefonos/telefonos.jsp">Teléfonos</a>
						</div>
					...
					<li>
						<div class="link">
							<img class="link-icon" alt="" src="../../public/address@2x.png" /> <a
								href="../../gestion/direcciones/direcciones.jsp">Direcciones</a>
						</div>
						<div class="link-subrayado"></div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<img alt="" src="../../public/cliente-manage.png"
					...
					<a class="nuevo-boton" href="formCrearCliente.jsp"> NUEVO CLIENTE
					...
					<form class="barra-buscar" action="clientes.jsp" method="get">
						<input type="text" name="c.cedula" placeholder="BUSCAR" >
...
<td>
    <a href="editarcliente2.jsp?id_cliente=<%=rs.getString(1)%>">
        <img class="link-icon" id="editar" src="../../public/edit@2x.png">
				...
				<td><a href="../citas/formNuevaCita.jsp?id_cliente=<%=rs.getString(1)%>"> <img class="link-icon" 
					src="../../public/create-order1@2x.png" style="width: 40px;   height: 40px;">
				</a>
				</td>
