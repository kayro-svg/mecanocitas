...
String query = "SELECT v.id_vehiculo, c.nombre, c.apellido, c.cedula, v.matricula, v.serieVin, v.marca, v.modelo, v.color, v.año " +
	...
	if (!id_cliente.isEmpty() && !id_cliente.equals("0")) {
	    query += " WHERE c.id_cliente = '" + id_cliente + "'";
	}
...
<title>MecanoCitas - Seleccionar Vehículo</title>
			...
			<div class="contenido">
				...
				<div class="parte-superior">					
					...
					<div>
						...
						<input type="text" placeholder="Buscar por matricula" name="v.matricula">
...
<form action="formNuevaCita.jsp" method="post">
<input type="hidden" name="id_vehiculo" value="<%=rs.getString(1)%>">
  <input type="hidden" name="marca" value="<%=rs.getString(7)%>">
  <input type="hidden" name="modelo" value="<%=rs.getString(8)%>">
  <input type="hidden" name="id_cliente" value="<%=id_cliente%>">
  <!-- Otros campos del formulario aquí -->
  <button type="submit" style="background: transparent; border: none;">
   <img class="link-icon" src="../../public/select.png" style="width: 40px;   height: 40px;">
