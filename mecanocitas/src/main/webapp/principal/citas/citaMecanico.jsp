...
<%@page import="java.sql.Connection"%>
	...
	String id_vehiculo = ""; //declaracion de la variable 'descripcion' de tipo string 
	id_vehiculo = (request.getParameter("id_vehiculo") != null) ? request.getParameter("id_vehiculo") : ""; //Valida que el nombre que viene por la url no sea NULL y le asigna un espacio en blanco " "
...
<title>MecanoCitas - Agregar Mecánico</title>
...
<form action="formNuevaCita.jsp" method="post">
  <input type="hidden" name="id_mecanico" value="<%=rs.getString(1)%>">
  <input type="hidden" name="nombre" value="<%=rs.getString(2)%>">
  <input type="hidden" name="apellido" value="<%=rs.getString(3)%>">
  ...
  <button type="submit" style="background: transparent; border: none;">
   <img class="link-icon" src="../../public/create-order1@2x.png" style="width: 40px;   height: 40px;">
  </button>
</form>
