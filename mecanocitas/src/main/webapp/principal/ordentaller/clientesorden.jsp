...
query += "WHERE c.id_cliente LIKE '%" + idcliente + "%' and c.nombre LIKE '%" + nombre + "%'";
		...
		<div>
			...
			<div class="contenido">
				...
				<div class="parte-superior">
					...
					<a class="nuevo-boton" href="../clientes/formCrearCliente.jsp"> NUEVO CLIENTE
...
<td>
		...
		<div class="dropdown">
			<a class="btn-custom btn-secondary dropdown-toggle" href="#"
				...
				<td><a href="formOrden.jsp?id_cliente=<%=rs.getString(1)%>"> <img class="link-icon" 
