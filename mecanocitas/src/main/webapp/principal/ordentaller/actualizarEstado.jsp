...
try {
    ...
    String updateQuery = "UPDATE ordenestado SET id_estado = " + id_estado + " WHERE id_orden = " + id_orden;
    String updateQueryOrdenTaller = "UPDATE ordentaller SET id_estado = " + id_estado + " WHERE id_orden = " + id_orden;


    int filasActualizadas = statement.executeUpdate(updateQuery);
    int filasActualizadas2 = statement.executeUpdate(updateQueryOrdenTaller);
    ...
    <div class="alert alert-success d-flex align-items-center" role="alert" style="width: fit-content;height: 75px;justify-content: center;gap: 15px;">
      ...
      <div>
        ¡Estado de la Orden de Taller actualizado!
      </div>
    </div>
    </div>
    <%
        ...
        out.println("No se pudo actualizar el estado de la orden.");
    ...
    e.printStackTrace();
    out.println("Error al actualizar el estado de la orden: " + e.getMessage());
}
%>
</main>
</body>
